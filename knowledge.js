const API_URL = "https://task-manager-murex-six.vercel.app/api";
fetchTasks();
...
function displayTasks(tasks) {
    ...
    tasks.forEach((task) => {
        ...
        listItem.innerHTML = `
            ...
            <button id="del" onclick="deleteTask('${task._id}')">Delete</button>
            <button id="mark" onclick="updateTaskStatus('${task._id}')">${task.status === 'done' ? 'Mark as Pending' : 'Mark as Done'}</button>
        `;
